            ...
            </Head>
            {
                viewPhotos == true ?
                    <div className="relative">
                        <div className="text-xl fixed w-full bg-white px-10 py-1 top-0 ">
                            <button onClick={() => setViewPhotos(false)}>
                                <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M28.546 17.88L26.666 16L18.666 24L26.666 32L28.546 30.12L22.4393 24L28.546 17.88Z" fill="#212629" />
                                </svg>
                            </button>
                        </div>
                        <section className="w-full flex justify-center bg-white overflow-y-scroll py-20 ">
                            <div className="w-4/6">
                                <PhotoAlbum onClick={() => setGallery(true)} layout="columns" photos={photos} />
                            </div>
                        </section>
                        {
                            gallery == true ?
                                <section className="w-full fixed top-0 left-0 h-screen flex justify-center bg-[#000] bg-opacity-90 py-20">
                                    <div onClick={() => setGallery(false)} className="fixed top-4 right-4 uppercase text-white">close</div>
                                    <Swiper
                                        cssMode={true}
                                        navigation={true}
                                        pagination={{
                        ...
                        <section className="min-h-screen px-10 my-20 ">
                            ...
                            <div className="my-10 w-full flex gap-x-5 justify-center ">
                                <div className="w-5/12">
                                    <img onClick={() => setViewPhotos(true)} src="../product1.png" className="cursor-pointer  rounded-l-xl drop-shadow-md" />
                                </div>
                                <div className="cursor-pointer  w-5/12 grid grid-cols-2 gap-5">
                                    <img onClick={() => setViewPhotos(true)} src="../product2.png" className="cursor-pointer  drop-shadow-md" />
                                    <img onClick={() => setViewPhotos(true)} src="../product3.png" className="cursor-pointer  rounded-tr-xl drop-shadow-md" />
                                    <img onClick={() => setViewPhotos(true)} src="../product4.png" className="cursor-pointer  drop-shadow-md" />
                                    <img onClick={() => setViewPhotos(true)} src="../product5.png" className="cursor-pointer  rounded-br-xl drop-shadow-md" />
                                </div>
                            </div>
                            <div className="flex gap-x-20">
                                <div className="w-7/12 px-10">
                                    ...
                                    <div className="my-5">
                                        <div className="flex gap-x-5 items-center">
                                            ...
                                            <h3 className="font-semibold">Abhishek is a Superhost</h3>
                                        </div>
                                    ...
                                    <div className="my-5">
                                        <div className="flex gap-x-5 items-center">
                                            <svg width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M9 12C10.6569 12 12 10.6569 12 9C12 7.34315 10.6569 6 9 6C7.34315 6 6 7.34315 6 9C6 10.6569 7.34315 12 9 12Z" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M9 1C6.87827 1 4.84344 1.84285 3.34315 3.34315C1.84285 4.84344 1 6.87827 1 9C1 10.892 1.402 12.13 2.5 13.5L9 21L15.5 13.5C16.598 12.13 17 10.892 17 9C17 6.87827 16.1571 4.84344 14.6569 3.34315C13.1566 1.84285 11.1217 1 9 1V1Z" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                            </svg>
                                    ...
                                    <button className="border-black hover:bg-black hover:text-white border px-5 py-2 rounded-xl font-medium text-black">
                                ...
                                <div className="w-4/12 flex justify-center">
                                    <div className="bg-[#F7FCFF] fit-content sticky top-10 p-5 w-5/6 border border-[#C4D1DB] rounded-xl shadow-lg">
                                        ...
                                        <button className="text-2xl text-center btn-booking rounded-xl p-2 text-offWhite font-bold w-full mt-8">Book</button>
                                    </div>
                                </div>
                            </div>
                            <div className="px-10 mt-20">
                                <div className="h-[1.5px] bg-[#C4D1DB] w-full my-6"></div>
                                <h3 className="text-2xl font-semibold">Included with this home</h3>
                                <p className="text-md text-[#737d84]">Helpful essentials you can expect when booking this home.</p>
                                <div className="grid grid-cols-4 my-20 w-full gap-x-5 gap-y-8">
                                    <AddOns name={"housekeeping"} img={'https://a0.muscache.com/im/pictures/c106bd54-cc3d-4704-8456-854614cd9e54.jpg?aki_policy=x_large'} />
                                    <AddOns name={"family gear"} img={'https://a0.muscache.com/im/pictures/2586034b-b601-4ab9-9317-7fb1c99f6b28.jpg?aki_policy=x_large'} />
                                </div>
                            </div>
                            <div className="px-10 mt-20">
                                <div className="h-[1.5px] bg-[#C4D1DB] w-full my-6"></div>
                                <h3 className="text-2xl font-semibold">Add on services</h3>
                                <p className="text-md text-[#737d84]">After booking this home, a trip designer can arrange any of these add-on services.</p>
                                <div className="grid grid-cols-4 my-20 gap-x-5 gap-y-8">
                                    <AddOns name={"Airport Transfer"} img={'https://a0.muscache.com/im/pictures/591a509f-d448-46fb-91ba-c0ab1720237d.jpg?aki_policy=x_large'} />
                                    <AddOns name={"Car Rental"} img={'https://a0.muscache.com/im/pictures/10667c47-de5d-40e1-b233-3e4894ee932c.jpg?aki_policy=x_large'} />
                                    <AddOns name={"Fresh groceries"} img={'https://a0.muscache.com/im/pictures/aeb255c9-09b1-4600-ba68-20c3d856ff9e.jpg?aki_policy=x_large'} />
                                    <AddOns name={"Childcare"} img={'https://a0.muscache.com/im/pictures/96559ae2-bbae-4980-b9c5-e02c1557c65a.jpg?aki_policy=x_large'} />
                                    <AddOns name={"Chef"} img={'https://a0.muscache.com/im/pictures/a5fbdb38-b4af-404d-bf29-2d0196d770dd.jpg?aki_policy=x_large'} />
                                    <AddOns name={"waitstaff"} img={'https://a0.muscache.com/im/pictures/7b088977-74aa-4c56-bfae-c6f2c557a24d.jpg?aki_policy=x_large'} />
                                    <AddOns name={"Security guard"} img={'https://a0.muscache.com/im/pictures/0b003f66-5f93-4c3c-ac79-11a4bdf077b4.jpg?aki_policy=x_large'} />
                                    <AddOns name={"Equipment rental"} img={'https://a0.muscache.com/im/pictures/e55b97cc-3e65-4ed5-a6f8-33c5614155ac.jpg?aki_policy=x_large'} />
                                </div>
                                <h3 className="text-md font-medium">Not seeing something that you would like to order?</h3>
                                <button className="border-black hover:bg-black hover:text-white border px-5 py-2 rounded-xl font-medium text-black capitalize mt-5">
...
const AddOns = ({ name, img }) => {
    return (
        <div>
            <div className="w-full h-44" style={{ backgroundImage: `url(${img})`, backgroundPosition: 'center', backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}></div>
            <h2 className="text-md font-medium capitalize mt-3">{name}</h2>
        </div>
    )
}